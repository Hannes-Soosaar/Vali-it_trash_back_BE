...
INSERT INTO "user" (id, role_id,company_id,email,password,status) VALUES (DEFAULT,1,1,'admin@prygi.ee','123','A');

--Insert data into the 'company' table
INSERT INTO company (id, user_id, name, registrationcode) VALUES (DEFAULT,1,'ADMIN', 123456);

--Insert data into the 'product' table EI TÖÖTA
INSERT INTO product (id, company_id, image_id, name, upc, info, status) VALUES (DEFAULT, 1, 1, 'toode', 123456789012,'pese ja viska', 'A');

--Insert data into the 'image' table
INSERT INTO image (id, data) VALUES (DEFAULT, E'\\x89504E470D0A1A0A');

--Insert data into the 'product_material' table SIIIIAAAA
...
INSERT INTO category (id, name) VALUES (DEFAULT, 'Plast- ja metallpakend');
